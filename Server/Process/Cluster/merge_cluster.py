from Server.Process.ActionUser.action_calculate_time import get_content_for_user_id,random_color_for_trip
...
class MergerCluster:
    ...
    def find_value_type_map(self):
        with open(f"teamplates\{self.cluster_file}.html", "r", encoding="utf-8") as file:
